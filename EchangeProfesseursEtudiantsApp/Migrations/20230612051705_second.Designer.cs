...
namespace EchangeProfesseursEtudiantsApp.Migrations
{
    ...
    [Migration("20230612051705_second")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EchangeProfesseursEtudiantsApp.Models.Mark", b =>
                {
            ...
            modelBuilder.Entity("EchangeProfesseursEtudiantsApp.Models.Mark", b =>
                {
                    b.HasOne("EchangeProfesseursEtudiantsApp.Models.Element", "elementmark")
                        .WithMany()
                        .HasForeignKey("IdElement")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EchangeProfesseursEtudiantsApp.Models.ApplicationUser", "applicationusermark")
                        .WithMany()
                        .HasForeignKey("IdUser");

                    b.Navigation("applicationusermark");

                    b.Navigation("elementmark");
                });
